...
class DiffusionNet(Module):
    ...
    def sample(self, num_pose, context, pose_dim, flexibility=0.0, ret_traj=False, uncondition_embedding=None, uncondition_embedding_text=None, unconditional_sample=False):
