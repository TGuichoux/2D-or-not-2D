...
import DiffGesture.scripts.utils.data_utils
from DiffGesture.scripts.model.vocab import Vocab
import DiffGesture.scripts.model
...
class SpeechMotionDataset(Dataset):
    def __init__(self, lmdb_dir, n_poses, subdivision_stride, pose_resampling_fps, mean_pose, mean_dir_vec,
        ...
        self.expected_spectrogram_length = DiffGesture.scripts.utils.data_utils.calc_spectrogram_length_from_motion_length(
    ...
    def __getitem__(self, idx):
        ...
        if do_clipping:
            ...
            audio = DiffGesture.scripts.utils.data_utils.make_audio_fixed_length(audio, self.expected_audio_length)
...
if __name__ == '__main__':
    precomputed_model = '/data/guichoux/TED/ted_dataset/lmdb_train_speaker_model.pkl'
    with open(precomputed_model, 'rb') as f:
        self.speaker_model = pickle.load(f)
