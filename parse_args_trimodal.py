...
def parse_args():
    ...
    parser.add("--tb_logdir", type=str, default="output/t")
    ...
    parser.add("--pose_dim", type=int, help="dimensionality of a skeleton")
    parser.add("--dimension", type=int, help="Either 2D or 3D")
